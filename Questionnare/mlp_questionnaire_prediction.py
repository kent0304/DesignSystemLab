...
# 学習済みモデルの読み込み
chainer.serializers.load_npz('mlp_questionnaire_matsuda.net', loaded_net)

df = pd.read_csv('ui_input_all.csv', header=0)
...
# 結果の行列をCSVファイルに書き出し
with open("mlp_questionnare_allresult.csv", "w") as f:
    # header を設定
    fieldnames = ["Total"]
